package common; /******************************************************************************
 *  Compilation:  javac common.StdIn.java
 *  Execution:    java common.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 * The {@code common.StdIn} class provides static methods for reading strings
 ...
 * <pre>
 *  while (!common.StdIn.isEmpty()) {
 *      double value = common.StdIn.readDouble();
 *      common.StdOut.println(value);
 *  }
 *  common.StdOut.println(sum);
 *  </pre>
 *
 ...
 * <pre>
 *  while (common.StdIn.hasNextChar()) {
 *      char c = common.StdIn.readChar();
 *      common.StdOut.print(c);
 *  }
 *  </pre>
 *
 ...
 * <pre>
 *  while (common.StdIn.hasNextLine()) {
 *      String line = common.StdIn.readLine();
 *      common.StdOut.println(line);
 *  }
 *  </pre>
 *
 ...
 * <pre>
 *  String[] words = common.StdIn.readAllStrings();
 *  </pre>
 *
 * <b>Differences with Scanner.</b>
 * {@code common.StdIn} and {@link Scanner} are both designed to parse
 * tokens and convert them to primitive types and strings.
 * The main differences are summarized below:
 * <ul>
 * <li> {@code common.StdIn} is a set of static methods and reads
 ...
 * and sockets.
 * <li> {@code common.StdIn} uses whitespace as the delimiter pattern
 * that separates tokens.
 * {@link Scanner} supports arbitrary delimiter patterns.
 * <li> {@code common.StdIn} coerces the character-set encoding to UTF-8,
 * which is the most widely used character encoding for Unicode.
 * <li> {@code common.StdIn} coerces the locale to {@link Locale#US},
 * for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 * and floating-point literals.
 * <li> {@code common.StdIn} has convenient methods for reading a single
 * character; reading in sequences of integers, doubles, or strings;
 * and reading in all of the remaining input.
 * </ul>
 * <p>
 * Historical note: {@code common.StdIn} preceded {@code Scanner}; when
 ...
 * Windows, and Linux.
 * The methods in {@code common.StdIn} are <em>blocking</em>, which means that they
 ...
 * If the input begins with the optional byte-order mask, {@code common.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to common.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to common.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to common.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to common.StdIn


    // do this once when common.StdIn is initialized
    static {
        resync();
    }

    /**
     * If common.StdIn changes, use this to reinitialize the scanner.
     */
